...
res = []
df_all = get_all_securities(types=['stock'], date='2018-03-23')
for index,row in df_all.iterrows():
    df_stock = get_price(index, end_date='2018-03-23', frequency='daily', fields=['close','high','low'], skip_paused=True, fq='pre', count=90)
    ...
    if flag:
       res.append(index)
xsg = get_locked_shares(stock_list=res, start_date='2018-03-23', forward_count=60)
xsg_codes = []
